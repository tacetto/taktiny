...
from .... import nn, Rngs
from ...modules.attention import JointAttention, Attention
from ...modules.ffn import FusedGateMLP
...
class Flux2Modulation(nn.Module):
    def __init__(self, dim: int, mod_param_sets: int = 2, bias: bool = False, seed: Rngs = None):
...
class JointAttentionBlock(nn.Module):
    def __init__(self, config: Flux2Config, seed: Rngs = None):
